...
void taylor_series_approx_factors(PCS *c0, double beta, int N, int N_order, int func_type)
{
    for (int i = 0; i < N; i++)
    {
        ...
        {
        case 9:
            c0[i * N_order + 8] = beta * (pow(beta * x, 7) * x / pow(x * x - 1, 4) - 28 * pow(beta * x, 6) * x * x / pow(1 - x * x, 4.5) - 28 * pow(beta * x, 6) / pow(1 - x * x, 3.5) - 378 * pow(beta, 5) * pow(x, 8) / pow(x * x - 1, 5) + 588 * pow(beta * x, 5) * x / pow(x * x - 1, 4) - 210 * pow(beta * x, 4) * beta / pow(x * x - 1, 3) - 3150 * pow(beta, 4) * pow(x, 8) / pow(1 - x * x, 5.5) - 5880 * pow(beta * x, 4) * x * x / pow(1 - x * x, 4.5) - 3150 * pow(beta * x, 4) / pow(1 - x * x, 3.5) - 420 * pow(beta, 4) * x * x / pow(1 - x * x, 2.5) + 17325 * pow(beta, 3) * pow(x, 8) / pow(x * x - 1, 6) - 35280 * pow(beta, 3) * pow(x, 6) / pow(x * x - 1, 5) + 22050 * pow(beta * x, 3) * x / pow(x * x - 1, 4) - 4200 * pow(beta * x, 2) * beta / pow(x * x - 1, 3) + 105 * pow(beta, 3) / pow(x * x - 1, 2) - 62370 * beta * beta * pow(x, 8) / pow(1 - x * x, 6.5) - 132300 * beta * beta * pow(x, 6) / pow(1 - x * x, 5.5) - 88200 * beta * beta * pow(x, 4) / pow(1 - x * x, 4.5) - 18900 * pow(beta * x, 2) / pow(1 - x * x, 3.5) - 630 * beta * beta / pow(1 - x * x, 2.5) - 135135 * beta * pow(x, 8) / pow(x * x - 1, 7) + 291060 * beta * pow(x, 6) / pow(x * x - 1, 6) - 198450 * beta * pow(x, 4) / pow(x * x - 1, 5) + 44100 * beta * x * x / pow(x * x - 1, 4) - 1575 * beta / pow(x * x - 1, 3) - 135135 * pow(x, 8) / pow(1 - x * x, 7.5) - 291060 * pow(x, 6) / pow(1 - x * x, 6.5) - 198450 * pow(x, 4) / pow(1 - x * x, 5.5) - 44100 * x * x / pow(1 - x * x, 4.5) - 1575 / pow(1 - x * x, 3.5)) * c0[i * N_order] / 40320.0;
        case 8:
            c0[i * N_order + 7] = beta * x * (-pow(beta * x, 6) / pow(1 - x * x, 3.5) + 21 * pow(beta * x, 5) * x / pow(x * x - 1, 4) - 21 * pow(beta * x, 4) * beta / pow(x * x - 1, 3) - 210 * pow(beta * x, 4) * x * x / pow(1 - x * x, 4.5) - 315 * pow(beta * x, 4) / pow(1 - x * x, 3.5) - 105 * pow(beta, 4) * x * x / pow(1 - x * x, 2.5) - 1260 * pow(beta, 3) * pow(x, 6) / pow(x * x - 1, 5) + 2205 * pow(beta * x, 3) * x / pow(x * x - 1, 4) - 1050 * pow(beta * x, 2) * beta / pow(x * x - 1, 3) + 105 * pow(beta, 3) / pow(x * x - 1, 2) - 4725 * beta * beta * pow(x, 6) / pow(1 - x * x, 5.5) - 8820 * pow(beta * x, 2) * x * x / pow(1 - x * x, 4.5) - 4725 * pow(beta * x, 2) / pow(1 - x * x, 3.5) - 630 * beta * beta / pow(1 - x * x, 2.5) + 10395 * beta * pow(x, 6) / pow(x * x - 1, 6) - 19845 * beta * pow(x, 4) / pow(x * x - 1, 5) + 11025 * beta * x * x / pow(x * x - 1, 4) - 1575 * beta / (x * x - 1, 3) - 10395 * pow(x, 6) / pow(1 - x * x, 6.5) - 19845 * pow(x, 4) / pow(1 - x * x, 5.5) - 11025 * x * x / pow(1 - x * x, 4.5) - 1575 / (1 - x * x, 3.5)) * c0[i * N_order] / 5040.0;
        case 7:
            c0[i * N_order + 6] = beta * (-x * pow(beta * x, 5) / pow(x * x - 1, 3) - 15 * pow(beta * x, 4) * x * x / pow(1 - x * x, 3.5) - 15 * pow(beta * x, 4) / pow(1 - x * x, 2.5) + 105 * pow(beta, 3) * pow(x, 6) / pow(x * x - 1, 4) - 150 * pow(beta * x, 3) * x / pow(x * x - 1, 3) + 45 * pow(beta, 3) * x * x / pow(x * x - 1, 2) - 420 * beta * beta * pow(x, 6) / pow(1 - x * x, 4.5) - 675 * beta * beta * pow(x, 4) / pow(1 - x * x, 3.5) - 270 * beta * beta * x * x / pow(1 - x * x, 2.5) - 15 * beta * beta / pow(1 - x * x, 1.5) - 945 * beta * pow(x, 6) / pow(x * x - 1, 5) + 1575 * beta * pow(x, 4) / pow(x * x - 1, 4) - 675 * beta * x * x / pow(x * x - 1, 3) + 45 * beta / pow(x * x - 1, 2) - 945 * pow(x, 6) / pow(1 - x * x, 5.5) - 1575 * pow(x, 4) / pow(1 - x * x, 4.5) - 675 * x * x / pow(1 - x * x, 3.5) - 45 / pow(1 - x * x, 2.5)) * c0[i * N_order] / 720.0;
        case 6:
            c0[i * N_order + 5] = beta * x * (-pow(x * beta, 4) / pow((1 - x * x), 2.5) - 10 * pow(beta, 3) * pow(x, 4) / pow(x * x - 1, 3) + 10 * pow(beta, 3) * x * x / pow(x * x - 1, 2) - 45 * beta * beta * pow(x, 4) / pow(1 - x * x, 3.5) - 60 * beta * beta * x * x / pow(1 - x * x, 2.5) - 15 * beta * beta / pow(1 - x * x, 1.5) + 105 * beta * pow(x, 4) / pow(x * x - 1, 4) - 150 * beta * x * x / pow(x * x - 1, 3) + 45 * beta / pow(x * x - 1, 2) - 105 * pow(x, 4) / pow(1 - x * x, 4.5) - 150 * x * x / pow(1 - x * x, 3.5) - 45 / pow(1 - x * x, 2.5)) * c0[i * N_order] / 120.0;
        case 5:
            c0[i * N_order + 4] = beta * (6 * beta * beta * pow(x, 10) + (-24 * beta * beta - 12) * pow(x, 8) + pow((1 - x * x), 3.5) * (beta * beta * beta * pow(x, 6) - pow(beta, 3) * pow(x, 4) - 12 * beta * x * x - 3 * beta) + (36 * beta * beta + 33) * pow(x, 6) + (-24 * beta * beta - 27) * pow(x, 4) + (6 * beta * beta + 3) * x * x + 3) * c0[i * N_order] /
